...
install:
	$(EMX) -C bestCP
	rm -f /home/kkho/em_beta/Compiler
	cp bestCP /home/kkho/em_beta/Compiler
	chmod -w /home/kkho/em_beta/Compiler

android:
	$(EMX) -C bestCP
	rm -f /home/kkho/em_output/Compiler
	cp bestCP /home/kkho/em_output/Compiler
	chmod -w /home/kkho/em_output/Compiler
